            ...
            <div class="page-header">
                ...
                <h3>Relatórios</h3>
                            ...
                            include_once('./conexao.php');
                                ...
                                echo "<button class='btn btn-primary' onclick=\"window.location.href='gerar_pdf_login.php?texto_pesquisar=$texto_pesquisar'\">Gerar PDF</button><br><br>";
                                ?>
                                ...
                                if (!empty($dados['PesqUsuario'])) {
                                    ...
                                    $query_usuarios = "SELECT id, nome, email, senha, telefone, cidade, estado, endereco
                                            FROM usuarios
