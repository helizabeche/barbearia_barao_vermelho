    ...
    <div class="sidebar">
        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    <li>
                       <a href="http://localhost/barbearia-barao/FUNCIONARIO/crud_agendamento/front.php" >
                            <span class="las la-home"></span>
                            <small>Dashboard</small>
                        </a>
                    </li>
                    <li>
                       <a href="http://localhost/barbearia-barao/FUNCIONARIO/imprimir%20relatorios/relatorios.php" class="active">
